...
public class TerramanServiceTest {
    ...
    private static final String TEST_SSH_KEY_NAME = "test_ssh_key";
    ...
    public void createTerramanTest() throws Exception {
        ...
        when(terramanProcessService.terramanProcessGetInstanceIp(TEST_MP_SEQ, TEST_CLUSTER_ID, TEST_PROCESS_GB, TEST_HOST, TEST_IDRSA, TEST_PROVIDER, TEST_CLUSTER_NAME, TEST_INT_SEQ, TEST_SSH_KEY_NAME)).thenReturn(TEST_MP_SEQ);
        when(terramanProcessService.terramanProcessSetKubespray(TEST_MP_SEQ, TEST_CLUSTER_ID, TEST_PROCESS_GB, TEST_HOST, TEST_IDRSA, TEST_PROVIDER, TEST_CLUSTER_NAME, TEST_SSH_KEY_NAME)).thenReturn(TEST_MP_SEQ);
        ...
        when(terramanProcessService.terramanProcessCreateVault(TEST_MP_SEQ, TEST_CLUSTER_ID, TEST_PROCESS_GB, TEST_HOST, TEST_IDRSA, TEST_PROVIDER, TEST_CLUSTER_NAME, TEST_SSH_KEY_NAME)).thenReturn(TEST_MP_SEQ);
